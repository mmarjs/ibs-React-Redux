...
class RiskCategories extends React.Component {
    constructor(props){
        super(props);
        this.state = {
            clientsData: [],
  ...
  render() {
    ...
    return <div>
        <Modal isOpen={this.state.openEdit} toggle={this.toggle}>
            <ModalHeader toggle={this.toggle}>Edit Risk Category</ModalHeader>
            <ModalBody>
        ...
        <Card>
            <CardTitle className="mb-0 p-3 border-bottom bg-light">
                <Row>
                    <Col sm="6">
                        <i className="mdi mdi-border-right mr-2"></i>Risk Category
                    </Col>
                    <Col sm="6" className="text-right">
                        <NavLink to={ "/admin/addClient/riskCategory" } color="success" activeClassName="active" className="btn btn-create-new">
...
const mapStateToProps = (state) => {
  return {
    clientsData: state.allClients.riskCategories
  }
} 

export default connect(mapStateToProps, null)(RiskCategories);
