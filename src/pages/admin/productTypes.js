  ...
  render() {
    ...
    return <div>
        <Modal isOpen={this.state.openEdit} toggle={this.toggle}>
            <ModalHeader toggle={this.toggle}>Edit Product Types</ModalHeader>
            <ModalBody>
        ...
        <Card>
            <CardTitle className="mb-0 p-3 border-bottom bg-light">
                <Row>
                    <Col sm="6">
                        <i className="mdi mdi-border-right mr-2"></i>Product Types
                    </Col>
                    <Col sm="6" className="text-right">
                        <NavLink to={ "/admin/addClient/productType" } color="success" activeClassName="active" className="btn btn-create-new">
...
const mapStateToProps = (state) => {
  return {
    clientsData: state.allClients.productTypes
  }
} 

export default connect(mapStateToProps, null)(ProductTypes);
